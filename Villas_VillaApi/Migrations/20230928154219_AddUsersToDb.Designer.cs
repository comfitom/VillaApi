...
namespace Villas_VillaApi.Migrations
{
    ...
    [Migration("20230928154219_AddUsersToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Villas_VillaApi.Models.LocalUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Villas_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 16, 42, 18, 51, DateTimeKind.Local).AddTicks(941),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 16, 42, 18, 51, DateTimeKind.Local).AddTicks(972),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 16, 42, 18, 51, DateTimeKind.Local).AddTicks(979),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 16, 42, 18, 51, DateTimeKind.Local).AddTicks(985),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 16, 42, 18, 51, DateTimeKind.Local).AddTicks(991),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
