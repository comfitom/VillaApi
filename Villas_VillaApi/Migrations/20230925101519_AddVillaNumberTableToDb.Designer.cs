...
namespace Villas_VillaApi.Migrations
{
    ...
    [Migration("20230925101519_AddVillaNumberTableToDb")]
            ...
            modelBuilder.Entity("Villas_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 25, 11, 15, 18, 650, DateTimeKind.Local).AddTicks(8979),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 25, 11, 15, 18, 650, DateTimeKind.Local).AddTicks(9001),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 25, 11, 15, 18, 650, DateTimeKind.Local).AddTicks(9005),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 25, 11, 15, 18, 650, DateTimeKind.Local).AddTicks(9008),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 25, 11, 15, 18, 650, DateTimeKind.Local).AddTicks(9010),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
