...
namespace Villas_VillaApi.Migrations
{
    ...
    [Migration("20230928132601_SetNullableAsFalses")]
    partial class SetNullableAsFalses
    {
            ...
            modelBuilder.Entity("Villas_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 26, 0, 899, DateTimeKind.Local).AddTicks(6833),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 26, 0, 899, DateTimeKind.Local).AddTicks(6851),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 26, 0, 899, DateTimeKind.Local).AddTicks(6855),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 26, 0, 899, DateTimeKind.Local).AddTicks(6858),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 26, 0, 899, DateTimeKind.Local).AddTicks(6860),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
