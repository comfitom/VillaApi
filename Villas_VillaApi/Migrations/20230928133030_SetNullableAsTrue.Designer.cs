...
namespace Villas_VillaApi.Migrations
{
    ...
    [Migration("20230928133030_SetNullableAsTrue")]
    partial class SetNullableAsTrue
    {
            ...
            modelBuilder.Entity("Villas_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 30, 30, 462, DateTimeKind.Local).AddTicks(6737),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 30, 30, 462, DateTimeKind.Local).AddTicks(6750),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 30, 30, 462, DateTimeKind.Local).AddTicks(6751),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 30, 30, 462, DateTimeKind.Local).AddTicks(6753),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 9, 28, 14, 30, 30, 462, DateTimeKind.Local).AddTicks(6754),
                            Details = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...",
